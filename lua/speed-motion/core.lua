...
function M.check_input()
  ...
  -- 1. Get user input (now reading line 2, which contains the current target/input)
  ...
  vim.api.nvim_win_set_cursor(window_id, { 3, current_index }) -- Line 3 (0-based line 2)
  ...
  if current_index >= target_len and typed_text == target_text then
